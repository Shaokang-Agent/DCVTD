...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, choices={'ac', 'il', 'il_dcvtd','ac_dcvtd'}, help='choose an algorithm from the preset', required=True)
    ...
    time_data = np.zeros([args.n_round])
